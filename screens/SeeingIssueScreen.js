...
export default class SeeingIssueScreen extends Component{
  constructor(props){
    ...
    this.state = {
      introductionText: "Welcome to Local Problems, here you will learn how to deal with seeing issues and how to use this app to help you. Below to the left is a button to play an audio book and to the right of it is a button to stop the audio. Below the buttons will be a link to send you to a page full of audio books made by the same person."
    }
  }
  ...
  render(){
    return(
      <View style = {styles.container}>
        ...
        <TouchableOpacity onPress = {() => Linking.openURL("https://librivox.org/leaves-of-grass-by-walt-whitman/").catch(err => console.error("Couldn't load page", err))} style = {styles.linkButton}>
